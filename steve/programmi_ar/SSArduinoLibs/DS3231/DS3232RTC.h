 ...
 *                                                                      *
 * This library will also work with the DS3232 RTC, which has the same  *
 ...
 *                                                                      *
 * Whether used with the DS3232 or DS3232, the user is responsible for  *
 * ensuring reads and writes do not exceed the device's address space   *
 * (0x00-0x12 for DS3232, 0x00-0xFF for DS3232); no bounds checking     *
