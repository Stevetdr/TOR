...
void setDS3231_gen(byte reg, byte val1);
...
Serial.print("secondi ");Serial.println(sec, DEC);
Serial.print("minuti  ");Serial.println(min, DEC);
Serial.print("ore     ");Serial.println(ore, DEC);
Serial.print("g of wk ");Serial.println(gow, DEC);
Serial.print("giorno  ");Serial.println(gio, DEC);
Serial.print("mese    ");Serial.println(mes, DEC);
Serial.print("anno    ");Serial.println(ann, DEC);
